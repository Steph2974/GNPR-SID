...
def build_geo_emb_for_poi_info(
    ...
    # 5) 回填到原 DataFrame
    poi_info_out["base_emb"] = None
    poi_info_out["geo_emb"] = None
    poi_info_out["anchor_angles"] = None

    poi_info_out.loc[valid_mask, "base_emb"] = base_emb.tolist()
    poi_info_out.loc[valid_mask, "geo_emb"] = geo_emb.tolist()
    poi_info_out.loc[valid_mask, "anchor_angles"] = angles.tolist()
